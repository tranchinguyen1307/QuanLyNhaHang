                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td colspan="3" class="text-right"><strong>Tổng cộng món ăn:</strong></td>
                                            <td><strong>{{ number_format(array_sum(array_column($cart, 'total')), 0, ',', '.') }}
                                                    VND</strong></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" class="text-right"><strong>Tổng cộng (bao gồm tiền
                                                    cọc):</strong></td>
                                            <td><strong>{{ number_format(array_sum(array_column($cart, 'total')) + $reservation->deposit, 0, ',', '.') }}
                                                    VND</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
