    ...
    <div class="container">
        @foreach ($posts as $post)
            <div class="card single_post">
                <div class="body">
                    <div class="img-post">
                        <img class="card-img-top" src="{{ asset('storage/images/post/avatar/' . $post->avatar) }}" alt="{{ $post->title }}" style="height: 200px; object-fit: cover;">
                    </div>
                ...
                <div class="footer">
                    ...
                    <ul class="stats">
                        ...
                        <li><a href="javascript:void(0);" class="fa fa-date">{{ \Carbon\Carbon::parse($post->created_at)->format('d/m/Y') }}</a></li>
