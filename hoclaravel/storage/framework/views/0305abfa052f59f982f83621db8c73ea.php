<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0 pe-4">
            ...
            <a href="<?php echo e(route('client.post')); ?>"
                class="nav-item nav-link <?php echo e(request()->is('client/bai-viet*') ? 'active' : ''); ?>">Bài viết</a>
...
</nav><?php /**PATH D:\FPT_Polytechnic\Ki_6\PHP_3\QuanLyNhaHang\hoclaravel\resources\views/components/client/navbar.blade.php ENDPATH**/ ?>