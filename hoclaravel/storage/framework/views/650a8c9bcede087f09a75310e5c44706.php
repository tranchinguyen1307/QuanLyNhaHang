                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                          ...
                          <td class = "row">
                            <a class="btn btn-primary col-2" href="<?php echo e(route('admin.menu.edit')); ?>">Sửa</a>
...
<?php echo $__env->make('admin.layouts.masterlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FPT Polytechnic\Php3\QuanLyNhaHang\hoclaravel\resources\views/admin/modules/category.blade.php ENDPATH**/ ?>