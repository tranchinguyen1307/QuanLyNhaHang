                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $reservationsWithTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo e(number_format(array_sum(array_column($cart, 'total')), 0, ',', '.')); ?>
                                                ...
                                                <td>
                                                    <!-- Chi tiết -->
                                                    <form action="<?php echo e(route('admin.invoices.show', $reservation->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.masterlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FPT Polytechnic\Php3\QuanLyNhaHang\hoclaravel\resources\views/admin/Modules/Invoices/list.blade.php ENDPATH**/ ?>